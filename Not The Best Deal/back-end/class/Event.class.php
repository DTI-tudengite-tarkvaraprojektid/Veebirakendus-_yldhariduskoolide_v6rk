...
class Event {
  ...
  private $connection;
	...
	function saveEvent($name, $type, $county, $parish, $city, $address, $postcode, $webpage) {

		$stmt = $this->connection->prepare("INSERT INTO s_schools2 (name, type, county, parish, city, address, postcode, webpage) VALUE (?, ?, ?, ?, ?, ?, ?, ?)");
		echo $this->connection->error;

		$stmt->bind_param("ssssssss", $name, $type, $county, $parish, $city, $address, $postcode, $webpage);
